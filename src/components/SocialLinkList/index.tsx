  ...
  <StyledSocialLinkList>
    ...
    <li>
      <a href="https://www.twitter.com/adammescher">
        <svg className="social-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M492 110c-17 7-36 12-56 15 20-12 36-31 43-54-19 11-39 19-61 24a97 97 0 00-165 88c-81-4-152-43-200-101a97 97 0 0030 129c-16 0-31-5-44-12v1c0 47 33 86 78 95a97 97 0 01-44 2c12 38 48 66 91 67a194 194 0 01-144 40 274 274 0 00424-245c19-13 35-30 48-49z" /></svg>
      </a>
    </li>
  </StyledSocialLinkList>
);
